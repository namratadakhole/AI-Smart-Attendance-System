          ...
          if (res.data) {
            ...
            if (res.data.count >= 20 || res.data.completed) {
              ...
              toast.success("All 20 Face Samples Captured Successfully!", {
                description: "You may now click 'Register Student'.",
              });
            }
          }
        } catch (err) {
  ...
  const handleStartCamera = async () => {
    try {
      ...
      if (res && res.status === "success") {
        ...
        toast.info("Camera feed started successfully.", { description: "Live face registration stream active." });
      } else {
      ...
      try {
        ...
        if (res && res.success) {
          toast.success("Professor Account Created Successfully!", {
            description: "No face samples required for Professor accounts.",
          });
          resetForm();
        } else {
      ...
      try {
        ...
        if (res && res.success) {
          toast.success("Student Account Registered Successfully!", {
            description: `Saved ${fullName} (${rollNo}) with 20 face samples into SQLite.`,
          });
          handleStopCamera();
          resetForm();
